        ...
        <div class=" flex-col justify-center items-center">
           <form method="POST" action="{{ route('barang.store') }}"  enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="kecacatan" name="kecacatan" value="{{ old('kecacatan') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" rows="5" >
                </div>

                <div class="mb-6">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="jumlah">Jumlah Barang:</label>
                    <input type="number" id="jumlah" name="jumlah" value="{{ old('jumlah') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" rows="5" required>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select  name="jenis_id" id="jenis_id" value="{{ old('jenis_id') }}">
                        @foreach ($jenis as $j)
                ...
                <div class="mb-6">
                    ...
                    <select name="kondisi_id" id="kondisi_id" value="{{ old('kondisi_id') }}">
